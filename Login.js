...
function normalmodeLogin(){
    document.querySelector("#corpo").style.backgroundImage="url(Imagens/background-login.png)"
...
function darkmodeLogin(){
    document.querySelector("#corpo").style.backgroundImage="url(Imagens/background-darklogin.png)"
